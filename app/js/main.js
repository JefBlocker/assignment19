...
},{"./parse_data":3,"jquery":15}],2:[function(require,module,exports){
'use strict';
...
},{"./ajax_setup":1,"./router":7,"jquery":15,"moment":16,"underscore":17}],3:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
var APP_ID = '5nanxgv8fEV2Uxww89idhvEnjOLJm6pJndiasktS';
var API_KEY = 'g7EJHDDalLAR58zOmYGFpt2JlJYXjx0rjFQtlXlS';
...
exports['default'] = _backbone2['default'].Model.extend({
  ...
  gravatarUrl: function gravatarUrl() {
    ...
    var hash = (0, _blueimpMd5.md5)(email);
...
},{"../parse_data":3,"backbone":12,"blueimp-md5":14}],5:[function(require,module,exports){
'use strict';
...
},{"../parse_data":3,"./contact":4,"backbone":12}],6:[function(require,module,exports){
'use strict';
...
},{"./contact":4,"./contacts":5}],7:[function(require,module,exports){
'use strict';
...
exports['default'] = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el = appElement;
    this.collection = new _resources.Contacts();
    ...
    this.$el.on('click', '.contact-list-item', function (event) {
      ...
      _this.navigate('contact/' + contactId, { trigger: true });
    });
  ...
  showContacts: function showContacts() {
    ...
    this.collection.fetch().then(function () {
      ...
      _this2.$el.html((0, _views.Contacts)(_this2.collection.toJSON()));
    });
  },
  ...
  showContact: function showContact(id) {
    ...
    if (contact) {
      ...
      this.$el.html((0, _views.Contact)(contact.templateData()));
    } else {
      this.showSpinner();
      contact = this.collection.add({ objectId: id });
      contact.fetch().then(function () {
        _this3.$el.html((0, _views.Contact)(contact.templateData()));
      });
    }
  }
...
},{"./resources":6,"./views":10,"backbone":12,"jquery":15}],8:[function(require,module,exports){
"use strict";
...
},{"./contact":8,"./contacts":9,"./spinner":11}],11:[function(require,module,exports){
"use strict";
